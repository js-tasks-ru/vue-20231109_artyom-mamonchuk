<template>
  <div class="calendar-view__cell" tabindex="0" :class="decor">
    ...
    <div class="calendar-view__cell-content">
      <slot name="events" :day-events="dayEvents" :event-day="eventDay" :event-month="eventMonth" />
    </div>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    eventDay() {
      return Number(this.day.date.split('-').at(2));
    },
    eventMonth() {
      return Number(this.day.date.split('-').at(1));
    },
  },
};
</script>
