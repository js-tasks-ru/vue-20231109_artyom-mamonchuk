<template>
	<div class="calendar-view">
		<UiCalendarControls v-model:year="year" v-model:month="month" />
		<UiCalendarWeekDays />
		<div class="calendar-view__grid">
			<UiCalendarCell v-for="day in days" :key="day.id" :day="day" :is-today="today === day.date" :date="day.date"
				:events="events">
				<template #events="{ dayEvents, eventDay, eventMonth }">
					<slot :events="dayEvents" :day="eventDay" :month="eventMonth" />
				</template>
			</UiCalendarCell>
		</div>
	</div>
